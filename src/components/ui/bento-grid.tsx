...
export const BentoGridItem = ({
  ...
  return (
    <Link
      href={href}
      className={cn(
        'group shadow-input hover:ring-4 ring-blueprint col-span-1 row-span-1 overflow-hidden relative flex flex-col space-y-4 rounded-[30px] duration-200 hover:scale-102',
        className,
      )}
    >
